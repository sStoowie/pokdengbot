...
async def main(ctx):
    ...
    embed = discord.Embed(title="POKDENG", description="ไพ่ในมือคุณ", color=0xe6337a)
...
bot.run('MTA0MTI1MjE0MTM3NDkwMjM4Mg.GTZusL.mTgIjFZQgD_6Yr7l7f4z9ZthZdHXX7vadZ0TvQ')
